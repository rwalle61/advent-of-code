  ...
  describe('part 1', () => {
    ...
    describe('runProgramFromStateStringWithInputs(<initialState>, <inputNumber>)', () => {
      test('part 1 example 1', () => {
        const input = 1;
        expect(runProgramFromStateStringWithInputs('3,0,4,0,99', [input]))
          .toMatchObject({
      ...
      test('answer part 1', () => {
        expect(runProgramFromStateStringWithInputs(puzzleInput, [1]))
          .toMatchObject({
            newState: [
      ...
      test('answer part 2', () => {
        expect(runProgramFromStateStringWithInputs(puzzleInput, [5]))
          .toMatchObject({
            newState: [

...
describe('day 3', () => {
  describe('part 1', () => {
    test('findIntersects(pathOfWire1, pathOfWire2)', () => {
      expect(findIntersects('R8,U5,L5,D3', 'U7,R6,D4,L4').sort())
        .toStrictEqual([new Point(6, 5), new Point(3, 3)].sort());
    });
    test('findNearestIntersect(pathOfWire1, pathOfWire2)', () => {
      expect(findNearestIntersect('R8,U5,L5,D3', 'U7,R6,D4,L4'))
        .toStrictEqual(new Point(3, 3));
    });
    describe('findDistanceToNearestIntersect(pathOfWire1, pathOfWire2)', () => {
      test('1st example', () => {
        expect(findDistanceToNearestIntersect(
          'R8,U5,L5,D3',
          'U7,R6,D4,L4',
        ))
          .toEqual(6);
  ...
  describe('part 2', () => {
    describe('wire.findStepsToPoint(point)', () => {
      test('wire 1', () => {
        ...
        expect(wire.findStepsToPoint(new Point(3, 3))).toEqual(20);
        expect(wire.findStepsToPoint(new Point(6, 5))).toEqual(15);
      });
      test('wire 2', () => {
    ...
    describe('sumStepsToShortestIntersect(pathOfWire1, pathOfWire2)', () => {
      test('1st example', () => {
        expect(sumStepsToShortestIntersect(
          'R8,U5,L5,D3',
          'U7,R6,D4,L4',
        ))
          .toEqual(30);

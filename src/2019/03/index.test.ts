...
describe('day 3', () => {
  describe('part 1', () => {
    test('findIntersects(pathOfWire1, pathOfWire2)', () => {
      expect(findIntersects('R8,U5,L5,D3', 'U7,R6,D4,L4').sort()).toStrictEqual(
        [new Point(6, 5), new Point(3, 3)].sort(),
      );
    });
    test('findNearestIntersect(pathOfWire1, pathOfWire2)', () => {
      expect(findNearestIntersect('R8,U5,L5,D3', 'U7,R6,D4,L4')).toStrictEqual(
        new Point(3, 3),
      );
    });
    describe('findDistanceToNearestIntersect(pathOfWire1, pathOfWire2)', () => {
      test('1st example', () => {
        expect(
          findDistanceToNearestIntersect('R8,U5,L5,D3', 'U7,R6,D4,L4'),
        ).toBe(6);
      });
      test('2nd example', () => {
        expect(
  ...
  describe('part 2', () => {
    describe('wire.findStepsToPoint(point)', () => {
      test('wire 1', () => {
        const wire = new Wire('R8,U5,L5,D3');
        expect(wire.findStepsToPoint(new Point(3, 3))).toBe(20);
        expect(wire.findStepsToPoint(new Point(6, 5))).toBe(15);
      });
      test('wire 2', () => {
        const wire = new Wire('U7,R6,D4,L4');
        expect(wire.findStepsToPoint(new Point(3, 3))).toBe(20);
        expect(wire.findStepsToPoint(new Point(6, 5))).toBe(15);
      });
    });
    describe('sumStepsToShortestIntersect(pathOfWire1, pathOfWire2)', () => {
      test('1st example', () => {
        expect(sumStepsToShortestIntersect('R8,U5,L5,D3', 'U7,R6,D4,L4')).toBe(
          30,
        );
      });
      test('2nd example', () => {

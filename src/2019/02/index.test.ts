...
describe('day 2', () => {
    ...
    describe('runProgramFromStateString(<stateString>)', () => {
      ...
      test('(<puzzleInput>)', () => {
        expect(
          ...
          1, 10, 39, 234, 2, 9, 43, 702, 1, 5, 47, 703, 2, 51, 6, 1406, 1, 5,
          55, 1407, 2, 13, 59, 7035, 1, 63, 5, 7036, 2, 67, 13, 35180, 1, 71, 9,
          35183, 1, 75, 6, 35185, 2, 79, 6, 70370, 1, 83, 5, 70371, 2, 87, 9,
          211113, 2, 9, 91, 633339, 1, 5, 95, 633340, 2, 99, 13, 3166700, 1,
          103, 5, 3166701, 1, 2, 107, 3166703, 1, 111, 5, 0, 99, 2, 14, 0, 0,
        ]);
      });
    });
    test('runProgramAndGetFirstValue(programStateString, 12, 2)', () => {
      expect(runProgramAndGetFirstValue(puzzleInput, 12, 2)).toBe(3166704);
    });
  });
  describe.skip('part 2', () => {
    ...
    test('answerDay2Part2(programStateString, <answer to part 2>)', () => {
      expect(answerDay2Part2(puzzleInput, 19690720)).toBe(8018);
    });
  });
});
